...
import { GET_APPEAL_STAT_BY_STATUS } from "../../../../../store/types";
import { useGetDynamic } from "../../../../../hooks/useGet";
import { useSelector } from "react-redux";

function SortTypes({ type, onChange, activeStatus }) {
  const user = useSelector(s => s.isUser || null);
  const [statusData, get, loader] = useGetDynamic();
