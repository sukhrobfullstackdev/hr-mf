...
import {CHECK_STAFF_PSYCHOLOGY} from "../../../../../store/types";
import NoData from "../../../../../components/NoData";
import Small from "../../../../../styleComponents/Small";

function StaffPsychology(){
    const [post,loader,res] = usePost(false);
    const [data,setData] = useState(null);
    const onSearch = (v)=>{
        post(CHECK_STAFF_PSYCHOLOGY,v);
    }
    useEffect(()=>{
        if(res){
                        ...
                        <>
                            ...
                            <Row gutter={15}>
                                <Col span={6}>
                                    ...
                                    <Row>
                                        <Col span={6}>
                                            <strong>{data.object.createdBy.name}</strong>
                                            <Small className={"text-muted"}>Hodim F.I.Sh.</Small>
                                        </Col>
                                        <Col span={6}>
...
export default StaffPsychology;