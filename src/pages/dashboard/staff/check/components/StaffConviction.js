...
import {Button, Col, Form, Input, InputNumber, Row, Skeleton} from "antd";
import usePost from "../../../../../hooks/usePost";
import {IconSearch} from "../../../../../components/Icon";
import {CHECK_STAFF_CONVICTION, CHECK_STAFF_NOROCLOGIE} from "../../../../../store/types";
import NoData from "../../../../../components/NoData";
import Small from "../../../../../styleComponents/Small";

function StaffConviction(){
    const [post,loader,res] = usePost(false);
    const [data,setData] = useState(null);
    const onSearch = (v)=>{
        post(CHECK_STAFF_CONVICTION,v);
    }
    useEffect(()=>{
        if(res){
...
export default StaffConviction;